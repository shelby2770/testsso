"""
Django settings for testsso project.
...
SECRET_KEY = 'django-insecure-a5a-@zk&9)as=9u(w3ju^a+1*-9wo6br^$9!ixdn$f^fp2gt4f'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'webauthn_auth.authentication.WebAuthnAuthentication',
...
WSGI_APPLICATION = 'testsso.wsgi.application'
